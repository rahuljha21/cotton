...
#load model
model =load_model(r'C:\Users\user\Desktop\agro\model\cotton.h5')
...
def pred_cot_dieas(cott_plant):
  ...
  if(pred == 0):
    return "Healthy Cotton Plant", 'disease_plant.html' # if index 0 burned leaf
  elif(pred == 1):
...
def predict():
  if request.method == 'POST':file = request.files['image'] # fet input
